...
/* ===================================================================================  */
//端子
#define ENCR_SSL PORTA.PODR.BIT.B6
#define ENCL_SSL PORTA.PODR.BIT.B4
#define MPU_SSL	PORTA.PODR.BIT.B3

// Buffer Size
#define BUFFER_SIZE_SPI	256

#define INT_RPI1_LEVEL 1

enum Spi_ssl {
	MPU6500, ENCR, ENCL, NON
};
...
#define MPU6500_PWR1_DEVICE_RESET_BIT   0x80
#define MPU6500_PWR1_SLEEP_BIT          0x40
#define MPU6500_PWR1_CYCLE_BIT          0x20
...
#define MPU6500_DMP_MEMORY_BANK_SIZE    128
...
typedef struct {
	short read;
	short write;
	unsigned short buff[BUFFER_SIZE_SPI];

} RSPI_FIFO;

extern long Spi_log_timer[5];
